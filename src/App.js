...
const [re, setre] = useState (false)
    useEffect(() => {
    fetch ('https://beatsback.herokuapp.com/beats')
    ...
    return (
       ...
       <Route exact path="/tutorial" component={Tutorial} />  
        ...
        <Provider>
            ...
            <img id='rick1' src='https://media0.giphy.com/media/ZE5DmCqNMr3yDXq1Zu/200w.gif' alt='rick'></img>
            <img id='rick2' src='https://media0.giphy.com/media/ZE5DmCqNMr3yDXq1Zu/200w.gif' alt='rick'></img>
            <Piano/>
