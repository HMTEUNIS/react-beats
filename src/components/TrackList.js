...
const TrackList = ({ currentStepID, selected, fetched, re, setre }) => {
    ...
    function loadin(e) {
        ...
        setSoundFileSelection({
            'Kick': trackList[0].name,
            'Snare': trackList[1].name,
            'Open Hat': trackList[2].name,
            'Closed Hat': trackList[3].name,
    ...
    let content = tempTrackList.map((track, trackID) => {
        let key = trackID
